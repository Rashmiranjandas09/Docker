...
```
docker build -t Rashmi/my-first-docker-image:latest .
```
...
rashmi/my-first-docker-image   latest    960d37536dcd   26 seconds ago   467MB
...
```
docker run -it rashmi/my-first-docker-image
```
...
```
docker push rashmi/my-first-docker-image
```
...
The push refers to repository [docker.io/rashmi/my-first-docker-image]
896818320e80: Pushed
b8088c305a52: Pushed
69dd4ccec1a0: Pushed
